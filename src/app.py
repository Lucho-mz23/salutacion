...
CORS(app) #modulo cors es para que me permita acceder desde el frontend al| 

# configuro la base de datos, con el nombre el usuario y la clave
app.config['SQLALCHEMY_DATABASE_URI']='mysql+pymysql://luchomz:dni34030585@luchomz.mysql.pythonanywhere-services.com/luchomz$default'
