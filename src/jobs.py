...
class UtilsMail():
    def __init__(self, urlGet="https://luchomz.pythonanywhere.com/personas/cumpleactual"):
        self.urlGet = urlGet
    ...
    def send_greetings_email(self, personas):
        ...
        smtp_port = 587
        smtp_username = 'sesegbalu.lujan@gmail.com'
        smtp_password = 'gmthfqxrwlcwsept'
...
# Realiza el job 1
url = 'https://luchomz.pythonanywhere.com/personas/actualizardiasrestantes'
